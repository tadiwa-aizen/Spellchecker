...
if __name__ == "__main__":
    ...
    for wrong, correct in test_cases:
        ...
        print(f"  ❌ Wrong word flagged: {'✓' if wrong_score < correct_score else '✗'} (Score: {wrong_score:.2f})")
        print(f"  ✅ Correct word accepted: {'✓' if correct_score > wrong_score else '✗'} (Score: {correct_score:.2f})\n")
